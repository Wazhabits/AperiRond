<div class="container">
    <div id='cart' class="row col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
        ...
        <?php
            $cart = GetTableSpe($database, "cart", 'user', 1);
            $i = 0;
            $total = 0;
            while ($i < count($cart)) {
        ...
        ?>
        <hr class='col-sm-12 col-xs-12 col-md-12 col-lg-12 col-xl-12'>
        <?php echo "<span class='row col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 center'><a href='command.php'><i class=\"fas fa-arrow-right\"></i> Terminer ma commande</a></span><span id='prix_tot' class='right col-sm-3 col-xs-3 col-md-3 col-lg-3 col-xl-3'>Prix total :</span><span id='prix_tot' class='right col-sm-3 col-xs-3 col-md-3 col-lg-3 col-xl-3'><strong>".$total."€</strong></span>"; ?>
    </div>
</div>